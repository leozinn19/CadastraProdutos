...
from services.marca_detalhada_service import train_test_marca_detalhada, process_marca_detalhada
...
vectorizer_sub_segmento, random_forest_sub_segmento, accuracy_sub_segmento, X = train_test_sub_segmento(
    dataframe_existing)
...
#    dataframe_existing)
# print('Processo 12 feito...')
# vectorizer_marca_detalhada, random_forest_marca_detalhada, accuracy_marca_detalhada = train_test_marca_detalhada(
#    dataframe_existing)
...
# acurracy('MARCA_DETALHADA', accuracy_marca_detalhada)
...
# processed_dataframe_new = process_marca_detalhada(
#    dataframe_new, vectorizer_marca_detalhada, random_forest_marca_detalhada)
